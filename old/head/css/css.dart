...
/* Dynamic scroll-content container layer */
...
/* Static desktop link list navigators */
...
/* Accordion components & section overrides */
...
/* Embedded Social Media Icon Rows Grid Layout */
...
/* ==========================================================================
   FIXED USER PROFILE ELEMENT ROW (GEMINI-STYLE AVATAR FOOTER ROW)
   ========================================================================== */
.avatar-footer-row {
...
/* ==========================================================================
   RESPONSIVE OVERRIDES: ADVANCED SYSTEM CHIN SAFE AREA INSET INTEGRATIONS
   ========================================================================== */
/* .mobile-bottom-navigation-bar { display: none; } */

/* 2. Instead, ONLY hide it if the screen is large AND it's not the editor */
/* Blogger injects a class for the editor, let's ensure it stays visible there */
.mobile-bottom-navigation-bar { display: block; }

@media (min-width: 993px) {
    /* Only hide on desktop, but keep visible if we are in the editor */
    body:not(.g-edit) .mobile-bottom-navigation-bar {
        display: none !important;
    }
}

@media (max-width: 992px) {
    .desktop-nav-fallback { display: none !important; }
    .btn-hamburger { display: flex; }
    .btn-close-sidebar { display: inline-block; }

    /* FIXED MOBILE SIDEBAR LAYOUT HEIGHT MODEL */
    #sidebar-drawer {
        position: fixed; 
        left: 0; 
        top: 0; 
    ...
    #sidebar-drawer.drawer-open { transform: translateX(0); box-shadow: 4px 0 20px rgba(0,0,0,0.2); }
    ...
    /* COMPLETE ABSOLUTE FLEXBOX CENTER ENGINE FOR MOBILE LINK WRAPPERS */
    .bottom-nav-item a {
        display: flex !important; 
        flex-direction: column !important;
        align-items: center !important; 
    ...
    /* BALANCED GRAPHICS POINT SHAPE TRACK HEIGHT CONSTRAINTS */
    .bottom-nav-icon-dot {
        ...
        margin: 0 !important; 
        padding: 0 !important;
        /* change to something makes it fade  */
    ...
    /* VERTICAL TEXT CENTER BALANCE ENGINE */
    .bottom-nav-text {
